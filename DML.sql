...
INSERT INTO `tfg`.`usuarios` (`nombre`, `contrasenia_hash`, `ultimo_cambio`, `activo`) VALUES ('ereyes', '$2a$10$SuuR6MXUkUpfonG1XA5YRuyUIyuQLA9c7oe6RCt3NoEOTcYB8BoG2', '2020-07-20 11:13:15', '1');
...
INSERT INTO `tfg`.`personas` (`id`, `numero_documento`, `nombre`, `apellido`, `telefono`, `domicilio`, `categorias_id_tipo_documento`, `categorias_id_rol`) VALUES ('1', '95933843', 'Ezequiel', 'Reyes', '388-343200', 'Parana 487', '1', '9');
INSERT INTO `tfg`.`personas` (`id`, `numero_documento`, `nombre`, `apellido`, `telefono`, `domicilio`, `categorias_id_tipo_documento`, `categorias_id_rol`) VALUES ('2', '93354553', 'Gaby', 'Droguett', '351-4108811', 'Rondeau 587', '1', '8');
INSERT INTO `tfg`.`personas` (`id`, `numero_documento`, `nombre`, `apellido`, `telefono`, `domicilio`, `categorias_id_tipo_documento`, `categorias_id_rol`) VALUES ('3', '98214560', 'Javier', 'Milei', '351-5961099', 'Obispo Salguero 300', '1', '10');
INSERT INTO `tfg`.`personas` (`id`, `numero_documento`, `nombre`, `apellido`, `telefono`, `domicilio`, `categorias_id_tipo_documento`, `categorias_id_rol`) VALUES ('4', '99488711', 'Lu', 'Serra', '351-6672201', 'Balcarce 222', '1', '11');
INSERT INTO `tfg`.`personas` (`id`, `numero_documento`, `nombre`, `apellido`, `telefono`, `domicilio`, `categorias_id_tipo_documento`, `categorias_id_rol`) VALUES ('5', '93958889', 'Marcelo', 'Renzo', '351-3267541', 'San Lorenzo 756', '1', '8');
INSERT INTO `tfg`.`personas` (`id`, `numero_documento`, `nombre`, `apellido`, `telefono`, `domicilio`, `categorias_id_tipo_documento`, `categorias_id_rol`) VALUES ('6', '98800536', 'Nahuel', 'Droguett', '351-6989044', 'Ituzaingo 484', '1', '8');
...
INSERT INTO `tfg`.`tatuadores` (`id`, `usuarios_nombre`, `personas_id`, `pseudonimo`) VALUES ('1', 'gdroguett', '2', 'DRA');
INSERT INTO `tfg`.`tatuadores` (`id`, `usuarios_nombre`, `personas_id`, `pseudonimo`) VALUES ('2', 'mrenzo', '5', 'Marchi Renzo');
INSERT INTO `tfg`.`tatuadores` (`id`, `usuarios_nombre`, `personas_id`, `pseudonimo`) VALUES ('3', 'ndroguett', '6', 'NQK');

INSERT INTO `tfg`.`fichas_clinica_piel` (`id`, `psoriasis`, `eccema`, `queloide`, `comentario`) VALUES ('1', '0', '0', '0', 'No aplica');
INSERT INTO `tfg`.`fichas_clinica_ets` (`id`, `vih`, `sifilis`, `hepatitis_b`, `hpv`, `comentario`) VALUES ('1', '0', '0', '0', '0', 'No aplica');
INSERT INTO `tfg`.`fichas_clinicas` (`id`, `grupo_sanguineo`, `factor_rh`, `alergias`, `problemas_cardiacos`, `comentarios`, `fichas_clinica_ets_id`, `fichas_clinica_piel_id`) VALUES ('1', '0', '+', 'Polen', 'No', 'No aplica', '1', '1');
