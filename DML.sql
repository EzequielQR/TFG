...
INSERT INTO `tfg`.`personas` (`id`, `numero_documento`, `nombre`, `apellido`, `telefono`, `domicilio`, `categorias_id_tipo_documento`, `categorias_id_rol`) VALUES ('3', '95933843', 'George', 'Cassi', '351-6781290', 'Bv. San Juan 394', '1', '9');
...
INSERT INTO `tfg`.`clientes` (`id`, `correo_electronico`, `fichas_clinicas_id`, `personas_id`) VALUES ('3', 'jhc@micorreo.com', '3', '3');
INSERT INTO `tfg`.`clientes` (`id`, `correo_electronico`, `fichas_clinicas_id`, `personas_id`) VALUES ('4', 'fer_fr@micorreo.com', '4', '4');
INSERT INTO `tfg`.`clientes` (`id`, `correo_electronico`, `fichas_clinicas_id`, `personas_id`) VALUES ('5', 'cali_maldon@micorreo.com', '5', '5');
...
INSERT INTO `tfg`.`turnos` (`id`, `descripcion`, `fecha_inicio`, `seña`, `personas_id_iniciado_por`, `categorias_id_estado`, `categorias_id_prioridad`, `tatuadores_id`, `clientes_id`) VALUES ('2', 'Maori en espalda', current_timestamp(), '500', '7', '6', '4', '1', '2');
INSERT INTO `tfg`.`turnos` (`id`, `descripcion`, `fecha_inicio`, `seña`, `personas_id_iniciado_por`, `categorias_id_estado`, `categorias_id_prioridad`, `tatuadores_id`, `clientes_id`) VALUES ('3', 'Realismo en pierna', current_timestamp(), '800', '7', '6', '4', '2', '3');
INSERT INTO `tfg`.`turnos` (`id`, `descripcion`, `fecha_inicio`, `seña`, `personas_id_iniciado_por`, `categorias_id_estado`, `categorias_id_prioridad`, `tatuadores_id`, `clientes_id`) VALUES ('4', 'Trash Polka en muslo', current_timestamp(), '1500', '9', '6', '4', '2', '4');
INSERT INTO `tfg`.`turnos` (`id`, `descripcion`, `fecha_inicio`, `seña`, `personas_id_iniciado_por`, `categorias_id_estado`, `categorias_id_prioridad`, `tatuadores_id`, `clientes_id`) VALUES ('5', 'Lettering en antebrazo', current_timestamp(), '1200', '9', '6', '4', '3', '5');
INSERT INTO `tfg`.`turnos` (`id`, `descripcion`, `fecha_inicio`, `seña`, `personas_id_iniciado_por`, `categorias_id_estado`, `categorias_id_prioridad`, `tatuadores_id`, `clientes_id`) VALUES ('6', 'New School en rodilla', current_timestamp(), '2500', '9', '6', '4', '3', '6');