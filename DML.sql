...
INSERT INTO `tfg`.`personas` (`id`, `numero_documento`, `nombre`, `apellido`, `telefono`, `domicilio`, `correo_electronico` ,`categorias_id_tipo_documento`, `categorias_id_rol`) VALUES ('3', '34000000', 'Leonard', 'di Prinzio', '351-6781290', 'Bv. San Juan 394', 'ldiprinzio@micorreo.com' ,'1', '9');
INSERT INTO `tfg`.`personas` (`id`, `numero_documento`, `nombre`, `apellido`, `telefono`, `domicilio`, `correo_electronico` ,`categorias_id_tipo_documento`, `categorias_id_rol`) VALUES ('4', '33000000', 'Ferdinand', 'Frias', '351-3198533', 'Chile 144', 'ffrias@micorreo.com' ,'1', '9');
INSERT INTO `tfg`.`personas` (`id`, `numero_documento`, `nombre`, `apellido`, `telefono`, `domicilio`, `correo_electronico` ,`categorias_id_tipo_documento`, `categorias_id_rol`) VALUES ('5', '32123456', 'Callixtus', 'Maldonado', '351-4667891', 'Av. Velez Sarfield 333', 'cmaldonado@micorreo.com' ,'1', '9');
...
INSERT INTO `tfg`.`turnos` (`id`, `descripcion`, `fecha_inicio`, `fecha_fin`, `seña`, `imagen_referencia`, `public_id_cloudinary`,`categorias_id_estado`, `categorias_id_prioridad`, `categorias_id_tipo_tatuaje`, `tatuadores_id`, `clientes_id`, `usuarios_nombre_iniciado_por`) VALUES ('1', 'Ryu en pierna.', DATE_ADD(current_timestamp(), INTERVAL -2 DAY), DATE_ADD(DATE_ADD(current_timestamp(), INTERVAL -2 DAY), INTERVAL 5 HOUR), '2000', 'https://i.pinimg.com/originals/ac/e7/b3/ace7b3e93a93dbc19be7c3c5d3aa129d.jpg', 'gipsh02gzzj4c6iziozw','6', '4', '18', '1', '1', 'gdroguett');
INSERT INTO `tfg`.`turnos` (`id`, `descripcion`, `fecha_inicio`, `fecha_fin`, `seña`, `imagen_referencia`, `public_id_cloudinary`,`categorias_id_estado`, `categorias_id_prioridad`, `categorias_id_tipo_tatuaje`, `tatuadores_id`, `clientes_id`, `usuarios_nombre_iniciado_por`) VALUES ('2', 'Popsicle en bicep.', DATE_ADD(current_timestamp(), INTERVAL -1 DAY), DATE_ADD(DATE_ADD(current_timestamp(), INTERVAL -1 DAY), INTERVAL 5 HOUR), '6000', 'https://i.pinimg.com/originals/dc/96/e3/dc96e36d207b4066b60fb3e5c75941d7.jpg', 'zxgyh189gjoyvfsvya9c','7', '4', '22', '1', '1', 'gdroguett');
...
INSERT INTO `tfg`.`turnos` (`id`, `descripcion`, `fecha_inicio`, `fecha_fin`, `seña`, `imagen_referencia`, `public_id_cloudinary`,`categorias_id_estado`, `categorias_id_prioridad`, `categorias_id_tipo_tatuaje`, `tatuadores_id`, `clientes_id`, `usuarios_nombre_iniciado_por`) VALUES ('4', 'Querubín en pierna.', DATE_ADD(current_timestamp(), INTERVAL -1 DAY), DATE_ADD(DATE_ADD(current_timestamp(), INTERVAL -1 DAY), INTERVAL 5 HOUR), '800', 'https://i.pinimg.com/originals/8a/dd/b3/8addb3a8cd04e650b971e86bba6344f2.png', 'cezkp7xeoi5nza3ajx8p', '6', '4', '25', '2', '3', 'lserra');
