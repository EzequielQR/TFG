...
public class RecepcionistaRepositoryImpl implements RecepcionistaRepository{
	...
	public Recepcionista getByPersonId(int idPerson) {
		// TODO Auto-generated method stub
		Session session = HibernateUtil.beginTransaction();
		Query query = session.createQuery("from Recepcionista where persona.id = :id");
	...
	@Override
	public Recepcionista getByUsername(String username) {
		// TODO Auto-generated method stub
		Session session = HibernateUtil.beginTransaction();
		Query query = session.createQuery("from Recepcionista where usuario.nombre = :user");
