...
<!--
1) Sin modal: Establecer un boton por panel. Hace click se muestra la imagen en una pestaña aparte.
2) Con modal: Hace click, se desplega el modal con la imagen full. Mostrar opciones al usuario.
-->
