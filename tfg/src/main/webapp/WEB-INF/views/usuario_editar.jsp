					...
					<sec:authorize access="hasRole('CUSTOMER')">
						...
						<li class="dropdown">
							<a class="dropdown-toggle" data-toggle="dropdown" href="#">Ficha Clínica<span class="caret"></span></a>
									<ul class="dropdown-menu">
										<li><a href="${pageContext.request.contextPath}/ficha-clinica/mostrar?id-cliente=${persona.id}">Visualizar</a></li>
										<li><a href="${pageContext.request.contextPath}/ficha-clinica/editar?id-cliente=${persona.id}">Editar</a></li>
									</ul>
						</li>
					</sec:authorize>
				</ul>
